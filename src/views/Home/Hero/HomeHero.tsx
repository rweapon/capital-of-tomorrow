  ...
  return (
    <section className='flex w-full flex-col px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24 mb-2 sm:mb-20 md:mb-22 overflow-hidden sm:overflow-visible header-buffer'>
      <div className='relative flex w-full flex-col justify-between gap-4 sm:flex-row xl:gap-20 xl:px-10'>
        <div className='flex flex-col gap-3 md:gap-5 max-w-80 sm:max-w-sm md:max-w-md xl:max-w-2xl'>
          ...
          <p className='font-monda text-base font-normal tracking-[-1.20px] text-[#ffffffc2] md:text-lg lg:text-xl mb-4 sm:mb-0'>
            {t('description')}
          </p>
          <FlipClock />
        </div>
        <div className='absolute right-4 top-0 sm:right-[unset] sm:relative sm:w-full min-w-10 md:max-w-32 xl:max-w-52'>
          <Image
            ...
            width={237}
            height={929}
            className='max-w-[unset] !w-40 md:max-w-40 lg:max-w-52 absolute top-0 -left-12 sm:-left-4 md:-left-8 lg:left-6 2xl:left-0 tower'
          />
        </div>
