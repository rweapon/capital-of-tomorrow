  ...
  return (
    <section className='container text-primary-foreground'>
      ...
      <p className='font-mont text-base sm:text-lg md:text-xl lg:text-2xl font-light md:leading-9'>
        ...
        social innovator, this is the place for you. This is not just a forum,
        but a place where ambitions meet support and ideas become action. It's
        time to act - your idea, your voice, your path starts here.
      </p>
    </section>
  );
}
