  ...
  return (
    <div className='flex w-full items-center justify-center px-3 sm:px-12 xl:px-24'>
      ...
      >
        ...
        />
        <div className='relative flex  flex-col md:min-h-[500px] lg:h-[500px] lg:flex-row-reverse'>
          <div
            className='bg partnership absolute right-0 top-0 h-[234px] w-[218px]  bg-cover  sm:h-72 md:static md:h-96 lg:h-full lg:w-[567px] lg:min-w-[567px]'
            style={{
