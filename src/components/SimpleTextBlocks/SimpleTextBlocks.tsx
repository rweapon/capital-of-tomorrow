        ...
        <div className="w-full">
            <div className="mx-auto max-w-7xl space-y-4 md:space-y-6 xl:space-y-0">
                ...
                <div className="block space-y-2.5 md:hidden">
                    <Block text={blockContent.largeBlocks[0]} size="large" className="h-32" />

                    {blockContent.smallBlocks.map((text, index) => (
                        <Block key={index} text={text} className="h-16" />
                    ))}

                    <Block text={blockContent.largeBlocks[1]} size="large" className="h-32" />
                </div>
            </div>
        </div>
    );
